...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190421065485-Modifying-Banded-Objects
updated_at: 2026-04-30T15:12:04Z
...
- In the Display and Group screens, specify the data to display in the banded object  accordingly.
 Use  to replace any current field. For more information about how to define a banded object, see Inserting Banded Objects in a Report.
...
- Select Hidden Objects in the View ribbon. Designer then displays the hidden panel and marks them with two triangles.

- Right-click the banded panel and select Show on the shortcut menu to release its hidden state.

- You may want to select Hidden Objects in the View ribbon again, because it does not show you a true view of your report.
