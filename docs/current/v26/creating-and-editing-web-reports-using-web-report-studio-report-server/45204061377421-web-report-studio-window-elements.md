...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45204061377421-Web-Report-Studio-Window-Elements
...
To customize the options in Web Report Studio, see Customizing Web Report Studio Profile.

The window elements of Web Report Studio vary with its two modes: View Mode and Edit Mode. The following table introduces the full UI elements based on the Edit Mode. The shortcut menu options vary with the objects you right-click, and the table only lists some typical items.
...
| Print | Select to print the web report in the Print dialog box. |  |
...
| Manage Datasets | Select to manage datasets in a web report. |  |
...
| Report Home Page | Select to access the Logi Analytics Home Page. |  |
...
| Redo | Select to reverse the operation of Undo. |  |
| Dataset Filter | Select to apply a filter to the dataset used by a data component. |  |
| Filter | Select to filter the report records according to the filter criteria you specify. |  |
| Save Bookmark | Select to bookmark the current web report. |  |
| Bookmark Setting | Select to manage bookmarks for the current web report. |  |
...
| Shortcut Menu | Edit Dataset Filter | Select to filter the dataset used by the selected data component according to the filter criteria you specify. |
