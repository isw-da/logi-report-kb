...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45203925472269-Customize-Waiting-Page-Dialog-Box-Properties
updated_at: 2026-04-30T14:09:05Z
...
- 
JSP File
 Select Browse to upload a JSP file from the local drive.  The required JSP file is not exactly a complete JSP but a segment. Its body can contain only one pair of root <div></div> tags and the non-body section can contain only tags that are allowed in the <body></body> tags.
