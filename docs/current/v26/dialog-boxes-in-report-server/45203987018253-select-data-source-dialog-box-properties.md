...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45203987018253-Select-Data-Source-Dialog-Box-Properties
...
When you do any of the following to create a table report using the quick start method:

- In the Select Catalog dialog box, select the required catalog and select OK.

- In Web Report Studio, select Menu > File > New Report or select the New Report button on the toolbar.
...
Select to open the Select Catalog dialog box to choose another catalog to use for the report. 
...
- 
Predefined Order
        Select to sort the business views in the order that you defined in the Business View Editor in Report Designer.
...
- 
Predefined Order
        Select to sort the objects in the order that you defined in the Business View Editor in Report Designer.
...
Search button
 Select to launch the search bar to search for objects listed in the box.
...
When you drag KPI from the Components panel or  from the visualization toolbar to the destination, the Select Data Source dialog box helps you select a business view to bind to the KPI and looks like this:
