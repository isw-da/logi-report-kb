...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45203954853517-Convert-to-Table-Dialog-Box-Properties
updated_at: 2026-04-30T14:09:32Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Convert to Table Dialog Box Properties

This topic describes how you can use the Convert to Table dialog box to convert a table to another table. Server displays the dialog box when you focus on a table and then select the table icon  on the visualization toolbar.
...
Select an order for sorting the group objects.
...
Select an order for sorting the aggregation objects.
...
Select an order for sorting the view elements.
