...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45203911919373-Format-Legend-Dialog-Box-Properties
...
Specify the font properties of the chart legend labels. See Font Tab Properties.
...
Specify the text of the legend entry labels. Type the label text manually, or select the formula button  and select a field from the list to use its values as the label text.
