...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45203984680077-Select-Field-Dialog-Box-Properties
...
When you select Add Dynamic Field in the Insert Link dialog box or Edit Link dialog box when the link type is URL or E-mail, you see the following properties in the Select Field dialog box:
...
Select an order from the drop-down list with which you want to sort the view elements. The order applies to all the resource trees where you see the business view in Web Report Studio.
