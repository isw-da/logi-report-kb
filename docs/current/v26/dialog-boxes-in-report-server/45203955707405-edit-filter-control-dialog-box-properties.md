...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45203955707405-Edit-Filter-Control-Dialog-Box-Properties
...
Server displays the dialog box when you right-click a filter control and then select Edit, or when you select the ellipsis button  beside the Filter On text box on the General tab of the Filter Control Properties dialog box.
