...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45203884697869-Edit-Dataset-Filter-Dialog-Box-Properties
updated_at: 2026-04-30T14:08:17Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Edit Dataset Filter Dialog Box Properties 

You can use the Edit Dataset Filter dialog box to apply a filter to the dataset that the specified data component uses, to narrow down its data scope. This topic describes the properties in the dialog box.
...
Select the filter you want to apply to the dataset. 

- 
User Defined
Select to create a user defined filter to apply to the dataset. 

- 
Predefined filters
 Server lists the names of the predefined filters which you created using the business view of the data component in Designer. You can choose one of them to apply.
    
- 
Edit
    Select to edit the selected predefined filter. Once you edit a predefined filter, Server saves it as a user defined filter in the dataset.
...
Specify the value of the field. You can either type the value manually in the text box or select a value from the list. Select the Toggle to Field button  or Toggle to Value button  to filter the field by either field or value.
