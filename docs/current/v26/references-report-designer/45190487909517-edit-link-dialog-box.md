...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190487909517-Edit-Link-Dialog-Box
...
You can use the Edit Link dialog box to edit the link on an object. This topic describes the options in the dialog box.
...
Specify the component in the detail report tab to interlink with the master report. Select the ellipsis  to add the components. You can add more than one component as long as the components are based on the same dataset.
