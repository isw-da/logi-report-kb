...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190544091149-Insert-Filter-Control-Dialog-Box
updated_at: 2026-04-30T15:13:48Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Insert Filter Control Dialog Box

You can use the Insert Filter Control dialog box to insert a filter control into a report for filtering data. This topic describes the options in the dialog box.
    

Designer displays the Insert Filter Control dialog box when you navigate to Insert > Web Controls > Filter Control, or drag the Filter Control icon  from the Components panel into a report.
...
- 
Fetch Data
Select to open the Fetch Data dialog box to select values from the database and add the selected values to the value text box.
...
Designer displays this option for the Slide filter types. You can use it to specify a special function for the selected fields if they are of the Date/Time type.
