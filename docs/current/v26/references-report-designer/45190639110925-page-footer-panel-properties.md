---
title: "Page Footer Panel Properties"
id: 45190639110925
section: "References - Report Designer"
category: "Logi Report"
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190639110925-Page-Footer-Panel-Properties
updated_at: 2026-04-30T15:15:49Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Page Footer Panel Properties

This topic describes the properties of a Page Footer Panel object.
...
| Suppress on Last Page | Page Report, Web Report | Specifies whether to display the panel on the last page of the report. Data type: Boolean |
| Suppress When No Records | Page Report, Web Report | Specifies whether to suppress the object in the report when no record is returned to its parent data component. Data type: Boolean Web Report Studio does not support this property on the object so it is ignored at runtime. |
| Underlay | Page Report, Web Report | Specifies whether to layer the panel beneath its subsequent object. This property is read only for the page footer panel, meaning, the panel cannot be underlaid. Data type: Boolean |
| Border |  |  |
