...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190643013645-Summary-Properties
...
| Function | Specifies the aggregate function of the summary. Data type: String |
| Group By | Specifies the group-by field (break-by group) on which to perform the summary. Data type: String |
| Length | Specifies the length for the values of the summary, in bytes. Data type: Integer |
...
| Special Function | Specifies the special function for the summary. Designer applies the special function when the group-by field of the summary is Numeric, String, Date, or Time data type. Data type: String |
