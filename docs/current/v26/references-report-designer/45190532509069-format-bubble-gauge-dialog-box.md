...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190532509069-Format-Bubble-Gauge-Dialog-Box
...
Use this tab to specify properties for the bubbles in the bubble gauge.

Bubbles

You can specify properties of the bubbles in this box.
...
You can specify properties for the border of the bubbles in this box.

- 
Show Border
Select to show the border of the bubbles. Designer enables the other border properties after you select this option.
...
Use this tab to specify properties for the frame of the bubble gauge.
...
Use this tab to specify properties for the hint of the bubble gauge. 
