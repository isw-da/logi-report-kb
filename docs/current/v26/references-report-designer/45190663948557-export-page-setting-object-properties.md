...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190663948557-Export-Page-Setting-Object-Properties
...
When you clear the Auto option for an export format and select OK in the Export tab of the Page Setup dialog box, Designer adds an export page setting object in the Report Inspector tree for this specific export format. By defining the properties of an export page setting object, you can customize the page settings for the output of the corresponding export format. This topic describes the properties of an Export Page Setting Object.
