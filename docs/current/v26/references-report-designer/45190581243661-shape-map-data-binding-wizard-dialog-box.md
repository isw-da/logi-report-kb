...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190581243661-Shape-Map-Data-Binding-Wizard-Dialog-Box
...
You can use the Shape Map Data Binding Wizard dialog box to bind a dataset to a shape map and display values on the shape map areas. This topic describes the options in the dialog box.
    

Designer displays the Shape Map Data Binding Wizard dialog box when you navigate to Menu > Insert > Bind Data, or select Bind Data on the toolbar in the Shape Map Editor dialog box.
...
- 
Custom Sort
Select to open the Custom Sort dialog box to set how to sort the groups.

Special Function

Select the special function for the group-by field when it is Numeric, String, Date, or Time data type. Select a special function from the drop-down list to specify to which level to  group the data, or select Customize to set the function in the Customized Function dialog box.
...
Select to open the Select N dialog box to specify the Select N condition for the groups.
