...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190740582669-Table-Detail-Properties
...
This topic lists the properties of a Table Detail object.
...
| Items per Block | Query Page Report | You can use Current Block Index and Items per Block together to control the data of the object you want to display in continuous page mode. Item per Block specifies the number of the records in each data block.Data type: Integer |
