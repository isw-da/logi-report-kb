...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190561363981-New-View-Element-Dialog-Box
updated_at: 2026-04-30T15:14:02Z
source_host: logi-report-v26.insightsoftware.com
---
# 
New View Element Dialog Box

You can use the New View Element dialog box to add a new view element into a business view. This topic describes the options in the dialog box.
    

Designer displays the New View Element dialog box when you perform one of the following:

- In the Business View Editor dialog box:
...
Designer displays the drop-down list only when the view element is an aggregation. It contains the aggregate functions that you can use for the aggregation object. Select the function you need.
