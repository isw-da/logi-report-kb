...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190578483725-Text-Option-Dialog-Box
...
Designer displays the Text Option dialog box when you set the Default Format for Viewing Report property of a report tab or a web report to "Text" and then select the ellipsis  in the value cell in the Report Inspector.
