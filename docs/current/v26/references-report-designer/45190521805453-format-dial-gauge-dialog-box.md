...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190521805453-Format-Dial-Gauge-Dialog-Box
updated_at: 2026-04-30T15:13:30Z
...
- 
Angle
Select the degree for angles of the dials. If you select "Customized", Designer displays the Customize Gauge Angle dialog box for you to customize the angle.
...
Select to show the names of the ranges that you define in the Range Color tab  in the dials. Designer enables the Font and Effects boxes in this tab after you select this option.
...
You can specify line properties of the major tick marks in this box.
...
You can specify line properties of the minor tick marks in this box.
...
- 
Color List 
Select to open the Color List dialog box to modify the color pattern for pointers in the same data series respectively.
