...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190587664397-Table-Filter-Condition-Dialog-Box
...
You can use the Table Filter Condition dialog box to filter a query based on a specified table. This topic describes the options in the dialog box.
    

Designer displays the Table Filter Condition dialog box when you select the filter icon  on the title bar of a table in the Query Editor dialog box.
...
Specify the field on which to define the condition. Select the ellipsis  to specify the field using the Expressions dialog box. 
