...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190573430797-PDF-Option-Dialog-Box
...
Designer displays the PDF Option dialog box when you set the Default Format for Viewing Report property of a report tab or a web report to "PDF" and then select the ellipsis  in the value cell in the Report Inspector.
