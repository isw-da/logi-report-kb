---
title: "Format Label Dialog Box"
id: 45190509221261
section: "References - Report Designer"
category: "Logi Report"
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190509221261-Format-Label-Dialog-Box
updated_at: 2026-04-30T15:13:33Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Format Label Dialog Box

You can use the Format Label dialog box to format labels of your charts. This topic describes the options in the dialog box.
    

Designer displays the Format Label dialog box when you right-click a label of a chart and select Format Label from the shortcut menu, or double-click a label in a chart. 
...
Use this tab to specify general properties of the label.

Text

Specify the text  in the label.

Icon

You can specify properties of the icon to display in the label in this box.

- 
Style
Select the style of the icon. Designer enables the other options in the Icon box when you do not select "no icon" from the drop-down list.

- 
Icon Text Gap
Specify the distance between the icon and the label text.

- 
Fill
Specify the fill pattern of the icon. To edit the fill pattern, select the color indicator and specify a color or effect using the color palette. You can also type the hexadecimal RGB value of a color  (for example, 0xff0000) in the text box.
...
- 
Width
Specify the width of the icon, in pixels.

- 
Height
Specify the height of the icon, in pixels.

Alignment

You can specify the alignment of the text and icon in this box.

- 
Text
Select the alignment of the text in the label.

- 
Icon
Designer enables this option when you select to display icon in the label. You can use it to specify the alignment of the icon relative to the text in the label.
...
Use this tab to specify the fill pattern of the label.

Color

Specify the color of the label. To edit the color, select the color indicator and select a color from the color palette, or type the hexadecimal RGB value of a color  (for example, 0xff0000) in the text box.

Transparency

Specify the transparency of the label.
...
Use this tab to specify properties for the border of the label.
...
Use this tab to specify the font properties of the text in the label.
...
Use this tab to specify the rotation angle for the text and icon in the label.

Angle

Specify the rotation angle of the text and icon in the label. When you change the rotation angle in the text box, the red line in the spin box changes correspondingly, and vice versa.
