...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190474551821-Connect-to-InterSystems-IRIS-Dialog-Box
updated_at: 2026-04-30T15:12:54Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Connect to InterSystems IRIS Dialog Box

You can use the Connect to InterSystems IRIS dialog box to specify the information for connecting to an InterSystems IRIS database via the connection plug-in. This topic describes the options in the dialog box.
    

Designer displays the Connect to InterSystems IRIS dialog box when you do one of the following:

- Select OK in the Create Connection to InterSystems IRIS  dialog box.

- Select InterSystems IRIS and select OK in the New Data Source dialog box.
