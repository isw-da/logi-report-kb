---
title: "Horizontal Banded Wizard Dialog Box"
id: 45190535842701
section: "References - Report Designer"
category: "Logi Report"
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190535842701-Horizontal-Banded-Wizard-Dialog-Box
updated_at: 2026-04-30T15:13:44Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Horizontal Banded Wizard Dialog Box

You can use the Horizontal Banded Wizard dialog box to create a page report tab with a horizontal banded object in it. This topic describes the options in the dialog box.
    

Designer displays the Horizontal Banded Wizard dialog box when you select the Horizontal Banded layout in the Select Component for Page Report dialog box or Select Component for Page Report Tab dialog box and select OK.
...
- 
Current Dataset
Designer disables this option because a banded object in a new page report tab cannot use  inherited dataset.
...
Select to create a restricted version of a flow layout report, one that can contain a single banded object only. This layout option is intended to provide compatibility with Report Version 7 report templates. 
...
Select to open the Page Setup dialog box to specify page properties for the report tab.
