...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190654002445-Banded-Object-Properties
updated_at: 2026-04-30T15:10:09Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Banded Object Properties

This topic describes the properties of a Banded Object that you can use in page reports and web reports.
...
| Cache | Page Report, Web Report | Specifies whether to cache the dataset for this object in the data buffer, so that other objects using the same dataset can share the data rather than perform their own SQL query. Data type: Boolean |
...
| Navigation Height | Web Report | Specifies the height of the frame for holding the banded object, when you set Enable Navigation of the object to "true". Type a numeric value to change the height. If you do not specify a value, Report Engine calculates the height at runtime. Data type: Float |
| Navigation Width | Web Report | Specifies the width of the frame for holding the banded object, when you set Enable Navigation of the object to "true". Type a numeric value to change the width. If you do not specify a value, Report Engine calculates the width at runtime.Data type: Float |
