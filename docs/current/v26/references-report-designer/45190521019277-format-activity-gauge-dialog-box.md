...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190521019277-Format-Activity-Gauge-Dialog-Box
updated_at: 2026-04-30T15:13:27Z
...
- 
Color
Specify the color of the circles. To edit the color, select the color indicator and select a color from the color palette, or type the hexadecimal RGB value of a color  (for example, 0xff0000) in the text box.

- 
Color List
Select to open the Color List dialog box to modify the color pattern for each circle.
