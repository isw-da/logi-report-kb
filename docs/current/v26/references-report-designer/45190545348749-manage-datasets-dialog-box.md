...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190545348749-Manage-Datasets-Dialog-Box
...
You can use the Manage Datasets dialog box to manage datasets in a report. This topic describes the options in the dialog box.
...
Select to open the New Dataset dialog box to add a new dataset in the report. Designer disables this button when you use the dialog box for managing datasets in a library component.
