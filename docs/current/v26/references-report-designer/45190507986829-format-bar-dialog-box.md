...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190507986829-Format-Bar-Dialog-Box
updated_at: 2026-04-30T15:13:28Z
...
- 
Use Depth
Specify whether to  add a 3-dimensional effect to the bars. You can select  to use a formula to control the property if the chart uses a query resource.
...
Specify the distance between the two adjacent bars within a group as a percentage of the width of a bar. This option takes effect in a clustered bar/bench chart which contains data on the series axis or has more than one value on the value axis.
 ...
 Designer displays the button  for some options. It indicates that you can use a formula to control the value of an option.
...
Select to display the static data labels at the specified position. If the labels overlap, Designer does not display some of them.
 ...
 After you set a rotation angle for the label text, Designer sets Auto Arrange to "false" automatically and disables this option.
