...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190521127309-Format-Area-Dialog-Box
...
- 
Use Depth
Specify whether to  add a 3-dimensional effect to the areas. You can select  to use a formula to control the property if the chart uses a query resource.
