...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190641075725-Formula-Properties
...
This topic describes the properties of a Formula object in a catalog.
...
| Expression | Shows the whole statement of the formula. Read only. |
| Length | Specifies the length for the return value of the formula, in byte. Data type: Integer |
