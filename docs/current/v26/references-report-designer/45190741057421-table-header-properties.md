...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190741057421-Table-Header-Properties
...
| Language | Query Page Report | This property is mapped to the HTML attribute lang, as specified by w3.org. Data type: String |
 ...
 For the Table Header object in web reports and library components, Report Engine can only render the properties that are available in the Web Report Studio Inspector panel at runtime.
