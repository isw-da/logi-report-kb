...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190562959757-Record-Level-Security-Information-Dialog-Box
updated_at: 2026-04-30T15:14:13Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Record Level Security Information Dialog Box

You can use the Record Level Security Information dialog box to edit the record level security for a query-based page report. This topic describes the options in the dialog box.
    

Designer displays the Record Level Security Information dialog box when you select the ellipsis  in the Report Inspector to specify the Record Security property of a dataset.
