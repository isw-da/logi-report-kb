---
title: "Format Platform Dialog Box"
id: 45190556243213
section: "References - Report Designer"
category: "Logi Report"
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190556243213-Format-Platform-Dialog-Box
...
Designer displays the Format Platform dialog box when you right-click any chart element and select Format Platform from the shortcut menu, or select the chart and double-click in the platform.
...
Use this tab to specify the fill pattern of the chart platform.

Color

Specify the color  of the platform. To edit the color, select the color indicator and select a color from the color palette, or type the hexadecimal RGB value of a color  (for example, 0xff0000) in the text box.

Transparency

Specify the transparency of the platform.
...
Use this tab to specify properties for the border of the chart platform.
