...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190556078477-Format-Paper-Dialog-Box
...
Specify the color  to fill the paper. To edit the color, select the color indicator and select a color from the color palette, or type the hexadecimal RGB value of a color  (for example, 0xff0000) in the text box.
