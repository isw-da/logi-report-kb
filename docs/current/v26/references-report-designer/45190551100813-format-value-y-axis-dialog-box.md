...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190551100813-Format-Value-Y-Axis-Dialog-Box
...
You can use the Format Value (Y) Axis dialog box to format the value axis (the Y axis) of a chart. This topic describes the options in the dialog box.
...
Use this tab to specify general properties of the value axis.
...
Use this tab to specify the font style of the major tick mark labels on the value axis.
