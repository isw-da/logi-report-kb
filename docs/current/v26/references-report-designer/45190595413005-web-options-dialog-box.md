...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190595413005-Web-Options-Dialog-Box
...
Designer displays these button for all the web control types:
...
Designer displays these options for the Text Field web control:
...
Designer displays these options for the Checkbox  web control:
...
Designer displays these options for the Drop-down List  web control:
...
This column shows the values that you specify for the items. You can either type the value in the cell or select the ellipsis  to specify a field to control the value using the Insert Fields dialog box.
...
Designer displays these options for the  List  web control:
