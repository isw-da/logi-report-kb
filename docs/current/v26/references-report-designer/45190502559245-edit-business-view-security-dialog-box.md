...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190502559245-Edit-Business-View-Security-Dialog-Box
updated_at: 2026-04-30T15:13:10Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Edit Business View Security Dialog Box

You can use the Edit Business View Security dialog box to define security for business views in a catalog. This topic describes the options in the dialog box.
    

Designer displays the Edit Business View Security dialog box when you do one of the following:

- Navigate to Menu > Tools > Security Configuration in the Business View Editor dialog box.
...
- 
Add User
Select to create a user in the Add User dialog box.

- 
Add Group
Select to create a group in the Add Group dialog box.

- 
Add Role
Select to create a role in the Add Role dialog box.

- 
Import from Report Server
Select to import principals from a started Server. If Designer cannot connect to the Server and sign you in automatically, it displays the Connect to Report Server dialog box for you to specify the connection and user information first.
...
- 
Edit button
Select to edit the allowed members in the Edit Values dialog box. 
...
- 
Edit button
Select to edit the denied members in the Edit Values dialog box.
