...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190378995981-Appendix-2-Formula-Operators
...
| text x + boolean y | When you add a text value to a Boolean value, the return value is a text value because the Boolean value can change to a text value, while the text value cannot change to a Boolean value. | The return value of the following statement is "falsefalse". ToText(3 
