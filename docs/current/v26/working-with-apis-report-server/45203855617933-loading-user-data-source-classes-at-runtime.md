...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45203855617933-Loading-User-Data-Source-Classes-at-Runtime
...
- 
Using the Server API static void jet.server.api.http.HttpUtil.initEnv(java.util.Properties props)Use the key server.dynamic.class.dir to set the location, for example:

System.getProperties().put("server.dynamic.class.dir", "C:\\LogiReport\\Server\\dynamic");
HttpUtil.initEnv(System.getProperties());

- 
Using the option -Dserver.dynamic.class.dir in the server/application startup fileIt will be loaded to system properties. Here is an example:

-Dserver.dynamic.class.dir=YOUR_FOLDER

- 
Using the property server.dynamic.class.dir in the server.properties file located in <install_root>\binThe default value of this property is <install_root>\dynamicclasses. Here is an example:
