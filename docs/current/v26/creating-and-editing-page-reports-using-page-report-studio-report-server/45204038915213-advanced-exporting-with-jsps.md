...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45204038915213-Advanced-Exporting-with-JSPs
updated_at: 2026-04-30T14:10:43Z
...
| browser | Specify the web browser type. | 0 - IE or Chrome 1 - Firefox | 0 |
| imagetype | Specify the type of the images in the output file. | 0 - Decided by Page Report Studio1 - GIF 2 - JPG | 0 |
| overflow | Specify the overflow type. | 0 - VISIBLE 1 - HIDDEN 2 - VERFLOWCOUNT | 0 |
...
| compatibility | Specify the encryption compatibility. | 0 - Acrobat 3.0 and later 1 - Acrobat 5.0 and later | 1 |
...
| printing | Specify the PDF printing mode. | 0 - Prevents users from printing the file 4 - Allows low resolution-printing 2052 - Allows high-resolution printing | 0 |
...
| to_open | Specify whether to export and open the output file. | true, false | false |
| to_local | Specify whether to save the report to a local file. | true, false | false |
| wrap | Specify the word-wrap setting. | 0 - All Keep Existing 1 - All Disabled 2 - All Enabled | 0 |
...
- Run a report in Page Report Studio, and you will see a new button Export to HTML on the toolbar.
...
- Run a report in Page Report Studio and you will see the buttons Export to HTML and Export to PDF on the toolbar.

- Select the added button on the toolbar of the report page, the report will be exported to the corresponding format, using the default values of the format options.
...
- Open the save_result.jsp file in the <install_root>\public_html\dhtmljsp folder with your favorite editor.

- Specify the value of customMsgForXML in the save_result.jsp to whatever you want. The value cannot be "" or null.

- Run a report in Page Report Studio.

- Select Menu > File > Export to display the Export dialog box.

- Select XML from the Select Report Result Format drop-down list

- Modify other properties.

- Select OK. Server displays a warning message as you have defined.
...
- Open the customize_panel.jsp file in the <install_root>\public_html\dhtmljsp folder with your favorite editor.

- Set the class of panelDIV to visibleMargin to show the Export panel on web browser. 

- Specify the value of customMsgForXML in customize_panel.jsp.

- Run a report in Page Report Studio, and the Export panel together with the report shows.

- Select XML from the Select Report Result Format drop-down list

- You can modify other properties.
