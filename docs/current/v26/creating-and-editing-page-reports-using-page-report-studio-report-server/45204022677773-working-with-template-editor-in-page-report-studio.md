...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45204022677773-Working-with-Template-Editor-in-Page-Report-Studio
updated_at: 2026-07-30T20:19:43Z
...
You can create dynamic resources in the Resources panel for use in the current report. Dynamic resources are saved with the report and do not modify the catalog.

To create a dynamic resource, select a business view or dataset in the Resources panel, right-click the applicable resource node, and select the command that you want to use.

You can create the following dynamic resources:

- 
Formulas: Create expressions by using fields, functions, and operators. You can use a formula as a detail, group, or aggregation field.

- 
Functions: Create reusable expressions for use in formulas.

- 
Aggregations: Create custom summary calculations for supported data components.

- 
Local Parameters: Create parameters for the current report. You can define static values, values that use bind columns, or cascading parameter values.

- 
Crosstab Formulas: Create formulas for use in crosstabs.

After you create a dynamic resource, Server displays it in the corresponding node in the Resources panel. You can drag the resource to a supported data component or use it in an expression.

To edit or remove a dynamic resource, right-click it in the Resources panel and select the corresponding command.
