...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190631820685-Report-v26-1-Release-Notes
updated_at: 2026-06-29T19:07:02Z
source_host: logi-report-v26.insightsoftware.com
---
# 
Report v26.1 Release Notes

This topic describes feature enhancements, resolved issues, and known issues of the Report v26.1 release, from March 31, 2026.
...
| Chart Rotation Issue | 05515274 | Pie and donut charts in web reports now export to PDF with the correct orientation, displaying consistently between the web view and the exported PDF. |
| Server error on dynamic connection creation | 05534103 | Setting a different database driver version in the Server classpath no longer throws IllegalAccessError. |
| Snap to Grid issue | 05536209 | Dragging and resizing components in Report Designer now correctly follows the Snap to Grid setting regardless of page margin values. |
| Calendar button display issue | 05536942 | The calendar button for date/time/datetime type-in parameters now displays in the correct position on the Server when the Re-enable Parameter Screen option is unchecked. |
