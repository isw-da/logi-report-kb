...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190631033485-Report-Licenses
...
Report has several add-on licenses. This topic describes the features each of the license enables.
...
A Live license for Designer enables you to use the following features in Designer:
...
A Live license for Server controls the real time ad hoc and analysis reporting. It enables you to use  the following features and functions on Server:
...
- All actions in Page Report Studio involving business views or changes to a report template, including: 
...
A JDashboard license for Designer enables the creation of library components which you can use to build dashboards, and publishing of library components to Server. 
