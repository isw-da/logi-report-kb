...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45203868414733-Configuring-Server-Monitor
...
| log.config.filename | \bin\LogConfig.properties | The path of the property file for configuring logs. |
...
| monitor.server.bin.path | \bin | The path of the bin folder that contains the startup file and properties files of Server Monitor. |
...
| server.property | \bin\server.properties | The path of the property file for configuring the Server Monitor properties. |
| servlet.property | \bin\servlet.properties | The path of the property file for configuring the servlet properties. |
| web.root | \public_html | The path of the public_html folder that is the standalone web app folder. |
