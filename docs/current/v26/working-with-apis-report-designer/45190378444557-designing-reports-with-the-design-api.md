...
url: https://logi-report-v26.insightsoftware.com/hc/en-us/articles/45190378444557-Designing-Reports-with-the-Design-API
updated_at: 2026-04-30T15:11:54Z
...
Designer is the principal class that manipulates reports. The application creates a Designer instance and calls the Designer methods to create or modify a report. For more information about the summary of FIELD, CONSTRUCTOR, and METHOD, see the jet.api package in the Report Java API Documentation.
...
This method deletes an existing report with the specified name, and returns "true" if the report is successfully removed. 
 ...
 When you create reports, you should create the reports based on an existing catalog file; otherwise, you get an error.
...
- 
public String addDynamicParameter(String reportHandle, ParameterInfo paramInfo)
This method adds a dynamic parameter into the report.
...
- 
public boolean modifyDynamicParameter(String paramHandle, ParameterInfo paramInfo)
This method changes the definition of a Dynamic Parameter.
...
- getColor(String handle, String name)
 ...
 You can use the getControlFields(String handle, String name) method to get fields that can control property values at runtime.
...
- 
getDynamicParameterHandles(String reportHandle)
This method gets all handles of dynamic parameter defined for the specified report.

- 
getDynamicParameterInfo(String paramHandle)
This method gets the dynamic parameter's information.
