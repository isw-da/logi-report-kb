...
url: https://docs-report.zendesk.com/hc/en-us/articles/28897679667213-Report-Development-Environment
...
| Insert | This menu tab contains options for inserting different report components into a report, such as Table, Chart, Crosstab, Map, KPI, Web Control, Image, and Label. You can also insert the components into a report by dragging them from the Components panel. |
...
The method to create a component using the Components panel is to drag an icon representing that component from the panel to the desired location in the report design area.
