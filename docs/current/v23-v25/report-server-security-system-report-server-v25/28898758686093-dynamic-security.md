...
url: https://docs-report.zendesk.com/hc/en-us/articles/28898758686093-Dynamic-Security
...
| Principal | Element | Visible Permission | Access Permission | Allowed Set | Denied Set | Allow Unspecified Members |
| --- | --- | --- | --- | --- | --- | --- |
| everyone | Orders Detail.Order ID | Allow | Allow | "Order ID" > 3431 And "Order ID" In the XML file, the business view security policy will be like this:
...
| Controls | Control the dynamic security. Upload Select to upload a catalog security file for a specific dynamic security in the Upload Dynamic Security dialog box. Download Select to download the catalog security file from Server. |
