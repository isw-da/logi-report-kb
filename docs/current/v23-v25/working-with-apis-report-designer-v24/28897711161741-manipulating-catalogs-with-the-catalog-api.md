...
url: https://docs-report.zendesk.com/hc/en-us/articles/28897711161741-Manipulating-Catalogs-with-the-Catalog-API
updated_at: 2024-09-30T09:12:33Z
...
You can use the method setQBE(String dataSourceName, String qryName, String tablename, String columnname, String expression) to add a new QBE condition to a query and return a Boolean value. The method returns "true" if the operation is successful; otherwise, it returns "false".
...
And use the method deleteCondition(String dataSourceName, String qryName, String sExpression1, String sOperator, String sExpression2, String sLogic) to delete the where conditions in a query and return a Boolean value. The method returns "true" if the operation is successful; otherwise, it returns "false".
...
This method gets the columns that can be grouped by in a query.
...
This method gets joins in a query and returns the join info array.
 String[i][0] = Table "From" Name, String[i][1] = Column "From" Name, String[i][2] = Table "To" Name, String[i][3] = Column "To" Name    

- 
getAndConditions(String dataSourceName, String queryName)
This method gets AND conditions in a query and returns a condition info array. String[i][0] = "Logic", String[i][1] = "Expression1" String[i][2] = "Operator", String[i][3] = "Expression2"

- 
getQBEInfo(String dataSourceName, String queryName)
This method gets the QBE condition in a query and returns a QBE info array. String[i][0] = column Name, String[i][j](j>=1) = condition expression of this column.
...
You can use the public boolean refreshReference() method to refresh the reference table of a catalog.

## 
Saving a Catalog

You can use the save() method to save an open catalog and return a Boolean value. The method returns "true" if the operation is successful; otherwise, it returns "false".

Or use the saveAs(String path, String name) method to save an open catalog as a new catalog file. You can save the catalog as a binary catalog using the extension .cat, or an XML catalog using the extension .cat.xml.
