...
url: https://docs-report.zendesk.com/hc/en-us/articles/28898129162765-Incremental-Condition-Dialog-Box
updated_at: 2024-09-30T09:10:47Z
...
You can use the Incremental Condition dialog box to specify conditions to filter the incremental data. This topic describes the options in the dialog box.
    

Designer displays the Incremental Condition dialog box when you select the the ellipsis  in the value cell of the Incremental Fetch property of a refresh object in a library component in the Report Inspector.
...
Select the logical operator to apply for the specified conditions. It can be "And" or "Or". 
...
Specify the value of how to filter the business view element. Select the ellipsis   to specify the value or select any of the following from the drop-down list.
