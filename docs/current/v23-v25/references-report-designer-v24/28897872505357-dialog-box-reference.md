...
url: https://docs-report.zendesk.com/hc/en-us/articles/28897872505357-Dialog-Box-Reference
updated_at: 2024-09-30T09:08:21Z
...
This topic introduces the dialog boxes in Designer. It provides descriptions and explanations of the options available in these dialog boxes.
 ...
 You can use either inch or centimeter as the unit of the measurement options such as Width, Height, and Thickness in Designer by customizing the Units option in the Options dialog box.
...
- Add Tables/Views/Synonyms Dialog Box

- Add User Dialog Box

- Advanced Dialog Box

- Advanced Export Settings Dialog Box

- Aggregate On Dialog Box

- Applet Parameter Dialog Box
...
- Category Property Dialog Box

- Change Property - Web Action Builder Dialog Box

- Change Property - Web Behavior Dialog Box
...
- Choose JDBC Connection Dialog Box

- Choose Page Report Dialog Box

- Click Priority Dialog Box
...
- Create Query's Username and Password Dialog Box
...
- CSS Editor Dialog Box

- CSS Style Definition Dialog Box

- Custom Sort Dialog Box

- Customize Chart Value Names Dialog Box
...
- Data Mapping Editor Dialog Box
...
- Download Customized Control Dialog Box

- Download from Report Server Dialog Box

- Edit Additional Value Dialog Box

- Edit Aggregation Dialog Box
...
- Edit Line Style Dialog Box

- Edit Link Dialog Box

- Edit Node Style Dialog Box
...
- Edit Shapes Dialog Box

- Edit Sort and Filter Dialog Box

- Edit Style Group Dialog Box
...
- Elasticsearch Data Source Options Dialog Box
...
- Export to Fax Dialog Box

- Export to Logi Report Result Dialog Box

- Export to Mail Dialog Box

- Export to PDF Dialog Box

- Export to PostScript Dialog Box

- Export to RTF Dialog Box
...
- Format Category (X) Gridline Dialog Box
...
- Format Floor Dialog Box

- Format Gauge Label Dialog Box

- Format Indicator Dialog Box

- Format KPI Label Dialog Box

- Format Label Dialog Box
...
- Format Pattern Dialog Box

- Format Pie Dialog Box

- Format Platform Dialog Box
...
- Format Rectangle Title Dialog Box
...
- Format TOC Title & Levels Dialog Box

- Format Value (Y) Axis Dialog Box

- Format Value (Y) Gridline Dialog Box

- Format Value (Y2) Axis Dialog Box

- Format Value (Y2) Gridline Dialog Box

- Format Wall Dialog Box
...
- Go Down - Web Action Builder Dialog Box

- Go To Dialog Box

- Go To - Web Action Builder Dialog Box

- Go Up Dialog Box

- Go Up - Web Action Builder Dialog Box
...
- Insert Page Panel Dialog Box

- Insert Parameter Control Dialog Box
...
- Insert Tabular Dialog Box

- Insert TOC Page Dialog Box

- Insert UDO Dialog Box
...
- Library Component Setting Dialog Box
...
- Manage Customized Controls Dialog Box
...
- New Computed Column Dialog Box

- New CSS Style Dialog Box

- New Customized Control File Dialog Box

- New Dataset Dialog Box
...
- Node Pattern List Dialog Box

- On-screen Filter Dialog Box
...
- Parameter Order Dialog Box

- PDF Option Dialog Box

- Pick a Color Dialog Box

- PostScript Option Dialog Box

- Pre-join Editor Dialog Box

- Precision Settings Dialog Box

- Predefined Filter Dialog Box

- Preview Option Dialog Box

- Publish Additional Resources Dialog Box

- Publish to Local Directory Dialog Box

- Publish to Report Server Dialog Box

- QR Code Expert Dialog Box

- Query Editor Dialog Box

- Query Modifier Editor Dialog Box
...
- Reset All Dialog Box

- RESTful Data Source Options Dialog Box

- RTF Option Dialog Box

- Save CSS As Dialog Box

- Save Library Component As Dialog Box

- Save Report As Dialog Box

- Save Style Dialog Box

- Scrollable Chart Dialog Box

- Search Dialog Box

- Search Condition Dialog Box

- Search Reports Dialog Box
...
- Select Area Name Dialog Box

- Select Component for Library Component Dialog Box

- Select Component for Page Report Dialog Box

- Select Component for Page Report Tab Dialog Box

- Select Field Dialog Box

- Select Fields Dialog Box

- Select Filter Resources Dialog Box

- Select Folder Dialog Box

- Select Group Position Dialog Box

- Select N Dialog Box

- Select Pre-join Dialog Box

- Select Report Tab Dialog Box
...
- Set Grids Dialog Box

- Shape Map Area Conditional Formatting Dialog Box

- Shape Map Canvas Setup Dialog Box

- Shape Map Data Binding Wizard Dialog Box

- Shape Map Editor Dialog Box

- Show Column Dialog Box

- Show Fields Dialog Box

- Sign Digital ID Dialog Box

- Size List Dialog Box
...
- Sort - Web Behavior Dialog Box

- Sort By Dialog Box

- Sort Fields By Dialog Box

- Special Function Dialog Box

- Stored Procedure Parameters Dialog Box

- Style List Dialog Box

- Subreport Dialog Box

- Suppress Column Grand Totals Dialog Box

- Suppress Column Subtotals Dialog Box

- Suppress Row Grand Totals Dialog Box

- Suppress Row Subtotals Dialog Box
...
- Tabular Wizard Dialog Box

- Text Option Dialog Box

- Time Zone and Locale Options Dialog Box

- UDF Classes Dialog Box

- Union Dialog Box

- Unique Key Dialog Box

- Update Procedures Dialog Box
...
- Web Report Option Dialog Box

- Web Wizard Dialog Box

- Windows Media Player Parameter Dialog Box
