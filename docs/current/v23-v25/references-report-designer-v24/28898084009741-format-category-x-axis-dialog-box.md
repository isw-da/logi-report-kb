...
url: https://docs-report.zendesk.com/hc/en-us/articles/28898084009741-Format-Category-X-Axis-Dialog-Box
updated_at: 2024-09-30T09:08:26Z
...
- 
Top
Specify the distance between the value and the top border.

- 
Bottom
Specify the distance between the value and the bottom border.

- 
Left
Specify the distance between the value and the left border.

- 
Right
Specify the distance between the value and the right border.
