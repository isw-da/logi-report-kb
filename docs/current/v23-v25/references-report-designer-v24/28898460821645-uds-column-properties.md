...
url: https://docs-report.zendesk.com/hc/en-us/articles/28898460821645-UDS-Column-Properties
...
This topic describes the properties of a Column object in a user-defined data source.

| Property Name | Description |
| --- | --- |
| General |  |
| Array | Specifies whether the column is an array type. Data type: Boolean |
| Auto Group Index | Specifies the index of the automatic group. The start index is 0, and if do not group by this column automatically, the index is -1. Data type: Integer |
...
| Length | Specifies the length for the values of the column, in bytes. Data type: Integer |
...
| Path String | Specifies the path of the column for identifying the column in tree. Data type: String |
