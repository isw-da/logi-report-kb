...
url: https://docs-report.zendesk.com/hc/en-us/articles/28897729485837-Introduction-to-Business-View-Security
updated_at: 2024-09-30T09:11:12Z
...
- 
Data Security
It controls whether a user/role/group in the security system of Server can access the data of the view elements at runtime. For a group object, you can further allow or deny the access of its specific members to a user/role/group. For more information, see Permission Logic on Group Objects.
...
Report classifies the relationship between a principal (user, role, or group) and the members of a group object in a business view  into three sets:
...
The following describes the detailed working logic.
...
{Accessible members of group1} And {Accessible members of group2} And... 
 ...
 If you define all members in a group object regardless of whether it is set to a principal directly or to the parents indirectly, Report Engine retrieves no data from the group object to the principal. 
