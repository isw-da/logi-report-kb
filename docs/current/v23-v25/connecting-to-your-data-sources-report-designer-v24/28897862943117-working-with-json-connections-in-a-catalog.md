...
url: https://docs-report.zendesk.com/hc/en-us/articles/28897862943117-Working-with-JSON-Connections-in-a-Catalog
...
Report provides several objects for fetching paginated JSON data. See the classes Client, JsonArrayBuilder, JsonObjectBuilder, and JsonPatch in the jet.formula.object package, and the classes fJsonArray, fJsonObject, fRequest, and fResponse in jet.formula in the Report Java API Documentation for more information. 
