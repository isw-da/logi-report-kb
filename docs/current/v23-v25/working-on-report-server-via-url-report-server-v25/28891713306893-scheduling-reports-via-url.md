...
url: https://docs-report.zendesk.com/hc/en-us/articles/28891713306893-Scheduling-Reports-via-URL
...
To publish the report to the versioning system in PDF format immediately, the URL used for this task could be:
