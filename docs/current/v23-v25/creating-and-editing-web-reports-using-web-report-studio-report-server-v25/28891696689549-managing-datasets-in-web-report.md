---
title: "Managing Datasets in Web Report"
id: 28891696689549
section: "Creating and Editing Web Reports Using Web Report Studio Report Server v25"
category: "Logi Report"
url: https://docs-report.zendesk.com/hc/en-us/articles/28891696689549-Managing-Datasets-in-Web-Report
updated_at: 2026-02-26T02:14:00Z
source_host: docs-report.zendesk.com
---
# 
Managing Datasets in Web Report

This topic describes how you can manage the datasets that a web report applies, for example, create more datasets in the report, specify the data fields to include in the datasets, and filter the datasets.
...
To manage the datasets in a web report, navigate to Menu > Edit > Manage Datasets to display the Manage Datasets dialog box.
...
- Define the filter conditions. For more information, refer to Applying Filters to Datasets for Data Components (start from step 2).

## 
Optimizing a Dataset

You can increase or decrease the scope of retrieved data for a dataset in a web report, and therefore make a balanceable decision between better performance and special usage cases/demands.
