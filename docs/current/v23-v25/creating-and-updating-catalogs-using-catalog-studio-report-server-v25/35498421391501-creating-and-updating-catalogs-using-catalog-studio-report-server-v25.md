---
title: "Creating and Updating Catalogs Using Catalog Studio Report Server v25"
id: 35498421391501
section: "Creating and Updating Catalogs Using Catalog Studio Report Server v25"
category: "Logi Report"
url: https://docs-report.zendesk.com/hc/en-us/articles/35498421391501-Creating-and-Updating-Catalogs-Using-Catalog-Studio-Report-Server-v25
updated_at: 2026-02-26T02:14:17Z
source_host: docs-report.zendesk.com
---
# 
Creating and Updating Catalogs Using Catalog StudioReport Server v25
...
- Save
You can save the current catalog, preserving any modifications made during the editing session. If the current catalog is neither new nor the latest, show the Merge Catalog dialog.
...
## 
Merge dialog Options in Catalog Studio

Display the Merge Catalog dialog when saving a catalog that is neither new nor the latest.

Merge options:

- Permissions conflict solution: automatic handling of permission conflicts:
- Replace - keep current permission;

- Skip - keep target permission;

- Resources conflict solution: automatic handling of resource conflicts:
- Replace - keep source resource;

- Skip - keep target resource;

- Add by New Name - add the resource with a new name.- Name Prefix Input: when choosing Add by New Name, specify the new name prefix.

- Cancel button- Close this merge dialog

- Merge button- Execute merge action

After clicking merge, the page remains open, awaiting merge completion.

Any errors during the merge process will display in this dialog. You can modify the merge solutions and retry, or cancel.

After a successful merge, the dialog will display the changed permissions and resources, and the catalog page will refresh after clicking the OK button.
