...
url: https://docs-report.zendesk.com/hc/en-us/articles/28898533650701-Image-Properties
...
Type a degree to rotate the image at a specified angle. You can type a negative number to rotate the image anticlockwise.
 ...
 As you rotate the image, it is possible that parts of the image will exceed the image area. Report does not display the parts of the image that go beyond the image area.
...
Specify the alternate text of the image. Report will display the alternate text when it cannot display the image.
