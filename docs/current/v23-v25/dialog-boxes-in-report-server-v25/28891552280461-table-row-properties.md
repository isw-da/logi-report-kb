...
url: https://docs-report.zendesk.com/hc/en-us/articles/28891552280461-Table-Row-Properties
updated_at: 2026-02-26T02:11:54Z
source_host: docs-report.zendesk.com
---
# 
Table Row Properties 

You can use the Table Row Properties dialog box to edit the properties of a table row. This topic describes the properties in the dialog box.
...
Specify the general properties of the table row.

Name

Specify the display name of the table row, which shows on its shortcut menu. 
...
Specify the background color of the table row.
