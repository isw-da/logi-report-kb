...
url: https://docs-report.zendesk.com/hc/en-us/articles/28891641534093-Format-Dial-Gauge-Dialog-Box-Properties
updated_at: 2026-02-26T02:11:36Z
...
- 
Angle
    Specify the degree for angles of the dials. Select the angle of the gauge from the list, or select Customized to open the Customize Gauge Angle dialog box to specify the start angle and end angle.
...
Select to show the names of the ranges you define on the Range Color tab. You can then use the following font properties to specify the format of the name text.
...
Show Target Value
    ...
    - 
Position
          Select the position of the target value relative to the dial. If you select customized, the X and Y settings on the General tab of the Format Target Label dialog box will take effect.
...
Show Gauge Group Name 
    ...
    - 
Position
          Select the position of the names relative to the dial. If you select customized, the X and Y settings on the General tab of the Format Gauge Label dialog box will take effect.
