---
title: "Format Gauge Label Dialog Box"
id: 12480104085517
section: "References - Report Designer v25"
category: "Logi Report"
url: https://docs-report.zendesk.com/hc/en-us/articles/12480104085517-Format-Gauge-Label-Dialog-Box
updated_at: 2026-02-25T23:49:27Z
source_host: docs-report.zendesk.com
---
# 
Format Gauge Label Dialog Box

You can use the Format Gauge Label dialog box to format the group labels in a gauge chart. This topic describes the options in the dialog box.
    

Designer displays the Format Gauge Label dialog box when you right-click a group label in a gauge chart and select Format Gauge Label from the shortcut menu, or double-click any group label in a gauge chart.
...
- 
Fill
Specify the  fill pattern of the labels. To edit the fill pattern, select the color indicator and specify a color or effect using the color palette. You can also type the hexadecimal RGB value of a color  (for example, 0xff0000) in the text box.
