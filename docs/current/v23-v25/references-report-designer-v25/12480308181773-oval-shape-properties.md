...
url: https://docs-report.zendesk.com/hc/en-us/articles/12480308181773-Oval-Shape-Properties
updated_at: 2026-02-25T23:47:54Z
source_host: docs-report.zendesk.com
---
# 
Oval Shape  Properties

This topic describes the properties of an Oval Shape object that you can use in page reports only.
...
| Geometry |  |
| Bottom Attach Pos X | Specifies the horizontal coordinate of the bottom right point of the focus box in the involved banded panel. Data type: Float |
| Bottom Attach Pos Y | Specifies the vertical coordinate of the bottom right point of the focus box in the involved banded panel. Data type: Float |
| Top Attach Pos X | Specifies the horizontal coordinate of the top left point of the focus box in the involved banded panel. Data type: Float |
| Top Attach Pos Y | Specifies the vertical coordinate of the top left point of the focus box in the involved banded panel. Data type: Float |
| Color |  |
