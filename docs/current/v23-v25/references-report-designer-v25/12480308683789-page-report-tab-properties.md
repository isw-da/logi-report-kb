...
url: https://docs-report.zendesk.com/hc/en-us/articles/12480308683789-Page-Report-Tab-Properties
updated_at: 2026-03-03T14:23:19Z
...
| Embedded Fonts | Specifies the True Type Fonts (TTF) and Open Type Fonts (OTF) that you want to embed in the PDF output of the report tab, if you have used TTF or OTF in the report tab. You can select multiple fonts from the value drop-down list by pressing the Ctrl or Shift key. For more information, see Delivering TTF in PDF. Data type: String |
